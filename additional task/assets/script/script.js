    ...
    container.innerHTML += `
        <div class="card">
            ...
            <div class="card__text">
                <p class="card__universe">Вселенная: ${item.universe}</p>
                <p class="card__alterego">Альтер эго: ${item.alterego}</p>
                <p class="card__occupation">Род деятельности: ${item.occupation}</p>
                <p class="card__friends">Друзья: ${item.friends}</p>
                <p class="card__superpowers">Суперсилы: ${item.superpowers}</p>
            </div>
